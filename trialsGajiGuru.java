...
public class trialsGajiGuru {
    static String[][] dataGuru; // array untuk menyimpan data guru
    static String status, jawaban, namaGuru, NIP, masuk, bulan, check; // data string yang akan digunakan
    ...
    // array sudah dihagaji
    // static String[][][] laporGaji = new String[3000][12][2];

    // array untuk menyimpan data gaji guru
    static String[][] dataGaji = new String[10][3];
        ...
        while (true) {
            ...
            if (masuk.equalsIgnoreCase("Guru")) {
                ...
                while (!isExit) {
                    ...
                    System.out.println("| 9. | Menu exit\t\t\t|"); // menu exit akan berjalan jika user nantinya memilih
                                                                   // n untuk
    ...
    static void perhitunganGaji(int pilihan) {
        ...
        //     for (int i = 0; i < dataGuru.length; i++) {
        //         String jurusan = dataGuru[0][1].substring(0, 2);
        //         System.out.println(jurusan);
        //         // s1
        //         if (pendidikan.equalsIgnoreCase(jurusan)) {
        //             System.out.println(namaGuru + " sebelumnya menempuh pendidikan " + dataGuru[i][1]);
        //             riwayat = true;
        //             break;
        //             // s2
        ...
        //         break;
        //     }
        // } while (!pendidikan.equalsIgnoreCase("S1") && !pendidikan.equalsIgnoreCase("S2"));
        ...
        // for (int i = 0; i < dataGuru.length; i++) {
        // // Proses status guru
        // if (status.equalsIgnoreCase(dataGuru[i][3])) {
        // System.out.print(
        // "Masukkan status PNS, contoh : 1, 2, 3, 4\n jawaban anda = ");
        // golongan = inputUser.nextInt();
        // statusGuru = true;
        // break;
        // } else if (status.equalsIgnoreCase(dataGuru[i][3])) {
        // System.out.print("Masukkan tarif mengajar perjamnnya = ");
        ...
        // } while (!status.equalsIgnoreCase("pns") &&
        // !status.equalsIgnoreCase("honorer"));
        ...
        if (status.equalsIgnoreCase("pns")) {
            System.out.print("Berapa lama guru " + namaGuru + " tidak hadir bulan ini,"
    ...
    static void laporanGaji(int pilihan) {
        ...
        System.out.print("Masukkan tanggal dan tahun penggajian(mm-yy)");
        ...
        //                     "==================================================================================");
        //             System.out.println(
        //                     "|\t" + jadwalGaji[i][1] + "\t|\t\t" + dataGuru[i][0] + "\t\t|\t" + jadwalGaji[i][2] + "\t|");
        //             System.out.println(
        //                     "==================================================================================");
        //         }
        //     }
        ...
        System.out.println(
            "==================================================================================");
        for (String[] data : jadwalGaji) {
            if (data[2] != null) {
                //cek apajah tanggal gaji sesuai dengan tanggal yang diinputkan
                if (bulan.equals(data[1].substring(3, 10))) {
                    // Cetak laporan gaji
                System.out.println(bulan);
                System.out.println(
        ...
        //     if (dataGaji[i][0] != null) {
        //         dataGaji[i][0] = jadwalGaji[i][1];
        //         System.out.println("Nama Guru: " + dataGaji[i][0]);
        //         dataGaji[i][1] = namaGuru;
        //         System.out.println("NIP: " + dataGaji[i][1]);
        //         dataGaji[i][2] = jadwalGaji[i][2];
        //         System.out.println("Gaji: " + dataGaji[i][2]);
        //     }
        // }
    }
